   ...
   <div class="modal-content">
     ...
     <div class="modal-body" >
       <div class="form-group">
           ...
           <p class="help-block">Carga tus clientes desde una hoja de cálculo, ya sea en formato .xlsx ó .ods. Para realizar la importación de datos, asegúrate de usar el formato correcto.</p>
       </div>
     </div>
