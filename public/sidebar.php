	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu" >
			...
			<li class="<?php echo $active_correos;?>"><a href="correos.php"><i class='fa fa-envelope-o'></i> Correos enviados</a></li>
			...
			<li class="<?php echo $active_fabricantes;?>"><a href="fabricantes.php"><i class='fa fa-tags'></i>  Marcas</a></li>
