<?php
	/*Inicia validacion del lado del servidor*/
		...
		$sql="INSERT INTO currencies (name, symbol, decimals, thousand_separator, decimal_separator, code) VALUES ('$nombre','$simbolo','$precision','$millar','$decimal','$codigo')";
		$query_new_insert = mysqli_query($con,$sql);
			if ($query_new_insert){
				$messages[] = "Moneda ha sido ingresada satisfactoriamente.";
			} else{
